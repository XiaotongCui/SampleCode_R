...
# ggsave('Results/vaccine date density_vaxrate.png', width = 7, height = 5, dpi = 300)
...
saveRDS(df.balance, file = 'Data/Demographics/balance1.rds')
...
table.main.reg <- 
  stargazer(m1, m2, m3, m5, m6, m7, m8, m9, m10, m11,
            ...
            type = "latex",
            out = "Results/Regression/main_20230703_vaxrate")
...
png("Results/Description/Map/heter_effects_0703_vaxrate.png")
