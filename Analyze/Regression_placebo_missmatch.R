...
df_friendvax <- readRDS("Data/Temp/friendvax_state_shuffle.rds")
df_friendvax_vaxrate <- readRDS("Data/Temp/friendvax_vaxrate_state_shuffle.rds")
df_friendlocation <- readRDS("Data/Temp/friendweights_state_shuffle.rds")
...
# save
saveRDS(df_state,file = 'Data/Final Data/state-sample-123999-shuffle.rds')
saveRDS(df_state_vaxrate,file = 'Data/Final Data/state-sample-vaxrate-123999-shuffle.rds')
...
df_wide <- readRDS("Data/Final Data/state-sample-123999-shuffle.rds")
df <- df_wide
...
stargazer(b.simple, b.FE, b.benchmark, b.2lag, omit = c("Constant", "week", "admin1Abb",
          ...
          type = "latex",
          out="Results/Regression/benchmark_20230106_shuffle")
