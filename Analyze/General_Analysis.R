...
# import data
df.wide <- readRDS('Data/Final Data/wide table_N=92356_v0525.rds')
df.long <- readRDS('Data/Final Data/long table_N=92356_v0525.rds')
...
table.main.reg <- 
  stargazer(m1, m2, m3, m5, m6, m7, m8, m9, m10, m11,
          ...
          type = "text",
          out = "Results/Regression/main_20230629")
...
table.heter.reg <- 
  stargazer(m3, h20, h21, h30, h31, h32, h40, h41,
            ...
            type = "text",
            out = "Results/Regression/heter_subgroup_v0629")
